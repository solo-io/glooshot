...
type Report_CapturePhase int32

const (
	// Experiment has just started
	Report_START Report_CapturePhase = 0
	// Experiment is currently running
	Report_RUN Report_CapturePhase = 1
	// Experiment has ended
	Report_FINISH Report_CapturePhase = 2
)

var Report_CapturePhase_name = map[int32]string{
	0: "START",
	1: "RUN",
	2: "FINISH",
}

var Report_CapturePhase_value = map[string]int32{
	"START":  0,
	"RUN":    1,
	"FINISH": 2,
}

func (x Report_CapturePhase) String() string {
	return proto.EnumName(Report_CapturePhase_name, int32(x))
}

func (Report_CapturePhase) EnumDescriptor() ([]byte, []int) {
...
type Report struct {
	...
	ExperimentName string `protobuf:"bytes,2,opt,name=ExperimentName,proto3" json:"ExperimentName,omitempty"`
	// the phase during which the progress report was captured
	CapturePhase Report_CapturePhase `protobuf:"varint,3,opt,name=capture_phase,json=capturePhase,proto3,enum=glooshot.solo.io.Report_CapturePhase" json:"capture_phase,omitempty"`
	// time the progress report was captured
	TimeStarted *types.Timestamp `protobuf:"bytes,4,opt,name=time_started,json=timeStarted,proto3" json:"time_started,omitempty"`
	// the measured values of each of the failure conditions at the time the report was captured
	FailureConditionValues []*Report_FailureConditionValue `protobuf:"bytes,5,rep,name=failure_condition_values,json=failureConditionValues,proto3" json:"failure_condition_values,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                        `json:"-"`
	XXX_unrecognized       []byte                          `json:"-"`
	XXX_sizecache          int32                           `json:"-"`
}
...
func (m *Report) GetExperimentName() string {
	if m != nil {
...
func (m *Report) GetCapturePhase() Report_CapturePhase {
	if m != nil {
		return m.CapturePhase
	}
	return Report_START
}

func (m *Report) GetTimeStarted() *types.Timestamp {
	if m != nil {
		return m.TimeStarted
	}
	return nil
...
func (m *Report) GetFailureConditionValues() []*Report_FailureConditionValue {
	if m != nil {
		return m.FailureConditionValues
	}
	return nil
}

type Report_FailureConditionValue struct {
	// Types that are valid to be assigned to Value:
	//	*Report_FailureConditionValue_ScalarMetric
	//	*Report_FailureConditionValue_String_
	Value                isReport_FailureConditionValue_Value `protobuf_oneof:"value"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}

func (m *Report_FailureConditionValue) Reset()         { *m = Report_FailureConditionValue{} }
func (m *Report_FailureConditionValue) String() string { return proto.CompactTextString(m) }
func (*Report_FailureConditionValue) ProtoMessage()    {}
func (*Report_FailureConditionValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_b9da8418b9c75752, []int{5, 0}
}
func (m *Report_FailureConditionValue) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Report_FailureConditionValue.Unmarshal(m, b)
}
func (m *Report_FailureConditionValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Report_FailureConditionValue.Marshal(b, m, deterministic)
}
func (m *Report_FailureConditionValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Report_FailureConditionValue.Merge(m, src)
}
func (m *Report_FailureConditionValue) XXX_Size() int {
	return xxx_messageInfo_Report_FailureConditionValue.Size(m)
}
func (m *Report_FailureConditionValue) XXX_DiscardUnknown() {
	xxx_messageInfo_Report_FailureConditionValue.DiscardUnknown(m)
}

var xxx_messageInfo_Report_FailureConditionValue proto.InternalMessageInfo

type isReport_FailureConditionValue_Value interface {
	isReport_FailureConditionValue_Value()
	Equal(interface{}) bool
}

type Report_FailureConditionValue_ScalarMetric struct {
	ScalarMetric float64 `protobuf:"fixed64,1,opt,name=scalar_metric,json=scalarMetric,proto3,oneof"`
}
type Report_FailureConditionValue_String_ struct {
	String_ string `protobuf:"bytes,2,opt,name=string,proto3,oneof"`
}

func (*Report_FailureConditionValue_ScalarMetric) isReport_FailureConditionValue_Value() {}
func (*Report_FailureConditionValue_String_) isReport_FailureConditionValue_Value()      {}

func (m *Report_FailureConditionValue) GetValue() isReport_FailureConditionValue_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *Report_FailureConditionValue) GetScalarMetric() float64 {
	if x, ok := m.GetValue().(*Report_FailureConditionValue_ScalarMetric); ok {
		return x.ScalarMetric
	}
	return 0
}

func (m *Report_FailureConditionValue) GetString_() string {
	if x, ok := m.GetValue().(*Report_FailureConditionValue_String_); ok {
		return x.String_
	}
	return ""
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*Report_FailureConditionValue) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Report_FailureConditionValue_OneofMarshaler, _Report_FailureConditionValue_OneofUnmarshaler, _Report_FailureConditionValue_OneofSizer, []interface{}{
		(*Report_FailureConditionValue_ScalarMetric)(nil),
		(*Report_FailureConditionValue_String_)(nil),
	}
}

func _Report_FailureConditionValue_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*Report_FailureConditionValue)
	// value
	switch x := m.Value.(type) {
	case *Report_FailureConditionValue_ScalarMetric:
		_ = b.EncodeVarint(1<<3 | proto.WireFixed64)
		_ = b.EncodeFixed64(math.Float64bits(x.ScalarMetric))
	case *Report_FailureConditionValue_String_:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.String_)
	case nil:
	default:
		return fmt.Errorf("Report_FailureConditionValue.Value has unexpected type %T", x)
	}
	return nil
}

func _Report_FailureConditionValue_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Report_FailureConditionValue)
	switch tag {
	case 1: // value.scalar_metric
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed64()
		m.Value = &Report_FailureConditionValue_ScalarMetric{math.Float64frombits(x)}
		return true, err
	case 2: // value.string
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		x, err := b.DecodeStringBytes()
		m.Value = &Report_FailureConditionValue_String_{x}
		return true, err
	default:
		return false, nil
	}
...
func _Report_FailureConditionValue_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*Report_FailureConditionValue)
	// value
	switch x := m.Value.(type) {
	case *Report_FailureConditionValue_ScalarMetric:
...
func init() {
	...
	proto.RegisterEnum("glooshot.solo.io.Report_CapturePhase", Report_CapturePhase_name, Report_CapturePhase_value)
	...
	proto.RegisterType((*Report_FailureConditionValue)(nil), "glooshot.solo.io.Report.FailureConditionValue")
}
...
var fileDescriptor_b9da8418b9c75752 = []byte{
	...
	,
}
...
func (this *Report) Equal(that interface{}) bool {
	...
	if this.ExperimentName != that1.ExperimentName {
		return false
	}
	if this.CapturePhase != that1.CapturePhase {
		return false
	}
	if !this.TimeStarted.Equal(that1.TimeStarted) {
		return false
	}
	if len(this.FailureConditionValues) != len(that1.FailureConditionValues) {
		return false
	}
	for i := range this.FailureConditionValues {
		if !this.FailureConditionValues[i].Equal(that1.FailureConditionValues[i]) {
			return false
		}
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
...
func (this *Report_FailureConditionValue) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Report_FailureConditionValue)
	if !ok {
		that2, ok := that.(Report_FailureConditionValue)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Report_FailureConditionValue_ScalarMetric) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Report_FailureConditionValue_ScalarMetric)
	if !ok {
		that2, ok := that.(Report_FailureConditionValue_ScalarMetric)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ScalarMetric != that1.ScalarMetric {
		return false
	}
	return true
}
func (this *Report_FailureConditionValue_String_) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Report_FailureConditionValue_String_)
	if !ok {
		that2, ok := that.(Report_FailureConditionValue_String_)
		if ok {
			that1 = &that2
		} else {
			return false
